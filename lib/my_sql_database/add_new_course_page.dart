...
class _AddNewCourseState extends State<AddNewCourse> {
  ...
  Future<void> addCourse(
    ...
    final data = await MySQLDbHelper.addCourse(
        courseName, courseImg, courseDuration, courseLink, coursePrice);
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      addCourse(courseName, courseImgUrl, courseDuration,
                          courseLink, coursePrice);
                      clearText();
                    });
                  },
